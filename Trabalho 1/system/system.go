...
func (s *System) Scan() []*document.Document {
	...
	documentListScan := []*document.Document{}
...
func (s *System) Delete(char string) {
	...
	if doc == nil {
		...
		s.Pages[doc.Page_id-1].RemoveDocument(doc.Seq - 1) //-1 porque a posição no array é id-1, o mesmo vale para seq
